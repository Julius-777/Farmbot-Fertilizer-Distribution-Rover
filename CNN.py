...
EPOCHS_TRAIN = 60 # number of iterations the training algorithim will do over the entire training set
...
saved_direc = os.path.join(os.getcwd(), 'savedh5\cnn_model_5.2.h5')
...
def main():
    ...
    model.save_weights('savedh5\cnn_model_weights_5.2.h5') # save only model weights
    ...
    try:
        model.fit_generator(train_gen,
                            ...
                            verbose=1)
        model.save('cnn_model_5.2.h5') #Save model parameters
        print('Model saved...')
